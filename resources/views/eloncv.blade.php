...
<nav class="navbar navbar-b navbar-trans navbar-expand-md fixed-top" id="mainNav">
    <div class="container">
        <a class="navbar-brand js-scroll" href="#page-top">RateRing</a>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="skill-mf">
                                    ...
                                    <span>swift</span> <span class="pull-right">90%</span>
                                    <div class="progress">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="service-box">
                        ...
                        <div class="service-content">
                            <h2 class="s-title">Ios Development</h2>
                            <p class="s-description text-center">
                            </p>
                        </div>
                    </div>
    ...
    <section id="work" class="portfolio-mf sect-pt4 route">
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="work-box">
                        <a href="{{URL::asset('assets/img/samer/1.jpeg')}}" data-gall="portfolioGallery" class="venobox">
                            <div class="work-img">
                                <img src="{{URL::asset('assets/img/samer/1.jpeg')}}" alt="" class="img-fluid">
                            </div>
                        </a>
                        <div class="work-content">
                            <div class="row">
                                <div class="col-sm-8">
                                    <h2 class="w-title">GHFollowers</h2>
                                    <div class="w-more">
                                        <span class="w-ctegory">Ios Development</span> / <span class="w-date">2019</span>
                                    </div>
                                </div>
                                <div class="col-sm-4">
                                    <div class="w-like">
                ...
                <div class="col-md-4">
                    <div class="work-box">
                        <a href="{{URL::asset('assets/img/samer/2.jpeg')}}" data-gall="portfolioGallery" class="venobox">
                            <div class="work-img">
                                <img src="{{URL::asset('assets/img/samer/2.jpeg')}}" alt="" class="img-fluid">
                            </div>
                        </a>
                        <div class="work-content">
                            <div class="row">
                                <div class="col-sm-8">
                                    <h2 class="w-title">Instagram With FireBase</h2>
                                    <div class="w-more">
                                        <span class="w-ctegory">Ios Development</span> / <span class="w-date">2019</span>
                                    </div>
                                </div>
                ...
                <div class="col-md-4">
                    <div class="work-box">
                        <a href="{{URL::asset('assets/img/samer/3.jpeg')}}" data-gall="portfolioGallery" class="venobox">
                            <div class="work-img">
                                <img src="{{URL::asset('assets/img/samer/3.jpeg')}}" alt="" class="img-fluid">
                            </div>
                        </a>
                        <div class="work-content">
                            <div class="row">
                                <div class="col-sm-8">
                                    <h2 class="w-title">Bfood</h2>
                                    <div class="w-more">
                                        <span class="w-ctegory">Ios Development</span> / <span class="w-date">2019</span>
                                    </div>
                                </div>
                ...
                <div class="col-md-4">
                    <div class="work-box">
                        <a href="{{URL::asset('assets/img/samer/4.jpeg')}}" data-gall="portfolioGallery" class="venobox">
                            <div class="work-img">
                                <img src="{{URL::asset('assets/img/samer/4.jpeg')}}" alt="" class="img-fluid">
                            </div>
                        </a>
                        <div class="work-content">
                            <div class="row">
                                <div class="col-sm-8">
                                    <h2 class="w-title">App Store Apis</h2>
                                    <div class="w-more">
                                        <span class="w-ctegory">Ios Development</span> / <span class="w-date">2020</span>
                                    </div>
                                </div>
                                <div class="col-sm-4">
                                    <div class="w-like">
                ...
                <div class="col-md-4">
                    <div class="work-box">
                        <a href="{{URL::asset('assets/img/samer/5.jpeg')}}" data-gall="portfolioGallery" class="venobox">
                            <div class="work-img">
                                <img src="{{URL::asset('assets/img/samer/5.jpeg')}}" alt="" class="img-fluid">
                            </div>
                        </a>
                        <div class="work-content">
                            <div class="row">
                                <div class="col-sm-8">
                                    <h2 class="w-title">Stars Face</h2>
                                    <div class="w-more">
                                        <span class="w-ctegory">Ios Development</span> / <span class="w-date">2020</span>
                                    </div>
                                </div>
