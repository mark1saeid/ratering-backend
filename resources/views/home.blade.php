...
<!--===============================================================================================-->
<script src="{{URL::asset('vendor/countdowntime/moment.min.js')}}"></script>
<script src="{{URL::asset('vendor/countdowntime/moment-timezone.min.js')}}"></script>
<script src="{{URL::asset('vendor/countdowntime/moment-timezone-with-data.min.js')}}"></script>
...
<!--===============================================================================================-->
<script src="{{URL::asset('js/jsload/main.js')}}"></script>
